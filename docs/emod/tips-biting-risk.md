...
distribution). Details on the values for these parameters can be found in [parameter-demographics](parameter-demographics.md).
...
1. Do heterogeneous biting risks apply when the model is configured to use forced EIR instead of mechanistic mosquito bites?
