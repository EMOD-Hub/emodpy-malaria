...
a simple *SEIRS model* with enhancements, EMOD contains a detailed *microsolver*
...
Immune variables, such as antibody levels for each antigen, inflammatory *cytokine* levels, and
...
*schizont* at the end of each asexual cycle, as well as the concentration of IRBC surface
