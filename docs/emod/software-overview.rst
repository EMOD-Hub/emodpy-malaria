...
EMOD is quite different from a :term:`deterministic` :term:`compartmental model`, which uses an
...
EMOD is also :term:`stochastic`, meaning that there is randomness built into the model.
