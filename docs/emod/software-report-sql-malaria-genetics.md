...
data, the report output is a multi-table SQLite relational database (see [DB Browser for SQLite](https://sqlitebrowser.org/) for more information). Use the configuration parameters to manage
