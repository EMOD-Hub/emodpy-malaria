...
.. csv-table::
    ...
    **Include_Data_Threshold_Hepatocytes**, float, 0, 3.40E+38, 0, "Minimum hepatocyte count required to include a row. Only applies when **Include_Column_Hepatocyte** is true. A value of 0 includes all rows."
    **Include_Data_Threshold_IRBC**, float, 0, 3.40E+38, 0, "Minimum IRBC count required to include a row. Only applies when **Include_Column_IRBC** is true. A value of 0 includes all rows."
    **Include_Data_Threshold_Gametocytes**, float, 0, 3.40E+38, 0, "Minimum gametocyte count required to include a row. Only applies when **Include_Column_Gametocyte** is true. A value of 0 includes all rows."
...
.. csv-table::
    ...
    Infectiousness, float, "The infectiousness of the individual — the probability that a feeding mosquito will become infected. This value is shared across all infections of the same individual."
...
.. csv-table::
    :header: Time,NodeID,IndividualID,Gender,AgeYears,InfectionID,Infectiousness,Duration,Hepatocytes,IRBCs,Gametocytes
    :widths: 5, 8, 8, 5, 8, 8, 8, 5, 8, 10, 8
    :file: ../csv/ReportInfectionStatsMalaria.csv
