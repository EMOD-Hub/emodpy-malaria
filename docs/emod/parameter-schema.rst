...
In most cases, you will not need to work with the schema directly — emodpy-malaria handles
...
emodpy-malaria. You can extract them using the ``emod_malaria.bootstrap`` module. Add the
