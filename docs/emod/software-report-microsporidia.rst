...
.. csv-table::
    :header: Time,NodeID,Species,MicrosporidiaStrain,VectorPopulation,STATE_INFECTIOUS,STATE_INFECTED,STATE_ADULT,STATE_MALE,STATE_IMMATURE,STATE_LARVA,STATE_EGG
    :widths: 5, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8
    :file: ../csv/ReportMicrosporidia.csv
