...
:   A way of characterizing a transition between two phases of matter; provides a method to find
    ...
    meteorology and climatology to describe the behavior of water vapor. See [Wikipedia - Clausius-Clayperon relation][wiki-clausius-clapeyron] for more information.
...
origin node
:   The starting point for each leg of a migration trip. The origin updates as individuals move between nodes.
...
recovered
:   Individual who is either no longer infectious, and is removed from the infected population.
...
:   The capacity of a pathogen to produce disease. It is proportional to parasitemia, or the
    ...
    the disease. There is a trade-off that occurs between high transmissibility and
