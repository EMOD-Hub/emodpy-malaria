...
class Genome:
    ...
    Args:
        barcode: Nucleotide string (characters A/C/G/T).
        allele_root_id: Root ID for allele tracking. Typically the
    ...
    def from_dtk_dict(dtk_dict: dict) -> Genome:
        ...
        Args:
            dtk_dict: A dict with ``m_pInner`` key containing genome data.
...
def replace_genomes(
    ...
    Args:
        ...
        next_barcode_fn: Callable returning a barcode string each time
            it is called.
...
def get_infection_barcodes(
    ...
    *,
    ...
    Args:
        ser_pop: A loaded SerializedPopulation.
        node_index: If provided, inspect only this node.
