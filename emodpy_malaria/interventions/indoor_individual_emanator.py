...
def _indoor_individual_emanator(campaign,
    ...
    Args:
        ...
        cost (float): Unit cost per **IndoorIndividualEmanator**.
        new_property_value (str): New IndividualProperty value to assign to individuals receiving this intervention. Must be
        ...
        intervention_name (str): The optional name used to refer to this intervention as a means to differentiate it from
            others that use the same class. It is possible to have multiple **IndoorIndividualEmanator** interventions
...
def add_indoor_individual_emanator_scheduled(campaign,
    ...
    Args:
        ...
        receiving_broadcast_event (str): Optional. **BroadcastEvent** that's sent out when **IndoorIndividualEmanator** is received.
        killing_initial_effect (float): Initial strength of the Killing effect. The effect may decay over time.
        killing_box_duration (float): Box duration of effect in days before the decay of **killing_initial_effect**.
        killing_decay_time_constant (float): The exponential decay length, in days of the **killing_initial_effect**.
        repelling_initial_effect (float): Initial strength of the Repelling effect. The effect may decay over time.
