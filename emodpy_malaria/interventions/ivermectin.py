...
def add_scheduled_ivermectin(campaign,
    ...
    Args:
        ...
        start_day (int): The day on which the intervention is distributed.
        ...
        cost (float): Unit cost per Ivermectin dosing (unamortized).
        ...
        broadcast_event (str): An event to be broadcast when a person receives Ivermectin intervention.
...
def add_triggered_ivermectin(campaign,
    ...
    It is possible to have multiple **Ivermectin** interventions attached to a person if they have
    ...
    Args:
        ...
        intervention_name (str): The optional name used to refer to this intervention as a means to differentiate it from
            others that use the same class.
        broadcast_event (str): An event to be broadcast when a person receives an **Ivermectin** intervention.
            Default: "Received_Ivermectin". You can turn this off by passing in an empty string or None.
    """
