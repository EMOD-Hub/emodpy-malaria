...
# todo: how to describe usage_ effects? how to make usage default WaningEffectConstant
    ...
    Args:
        ...
        usage_box_duration: Box duration of effect in days before the decay of **usage_initial_effect**.
        usage_decay_time_constant: The exponential decay length, in days of the **usage_initial_effect**.
        ...
        intervention_name: The optional name used to refer to this intervention as a means to differentiate it from
            others that use the same class. It is possible to have multiple **SimpleBednet** interventions
...
def new_intervention_as_file(campaign, start_day, filename=None):
    ...
    Args:
        campaign (emodpy.campaign.emod_campaign.EMODCampaign): The `emod_api.campaign` object to which the intervention will be added.
...
def add_itn_scheduled(campaign,
    ...
    Args:
        ...
        coverage_by_ages (list): A list of dictionaries defining the coverage per
        ...
        receiving_itn_broadcast_event (str): Optional. **BroadcastEvent** that's sent out when bednet is received.
        ...
        blocking_box_duration (float): Box duration of effect in days before the decay of **blocking_initial_effect**.
        ...
        repelling_box_duration (float): Box duration of effect in days before the decay of **repelling_initial_effect**.
        repelling_decay_time_constant (float): The exponential decay length, in days of the **repelling_initial_effect**.
        usage_initial_effect (float): Determines when and if an individual is using a bed net.
        usage_box_duration (float): Box duration of effect in days before the decay of **usage_initial_effect**.
        usage_decay_time_constant (float): The exponential decay length, in days of the **usage_initial_effect**.
        insecticide (str): The name of the insecticide defined in config.Insecticides for this intervention.
            If insecticides are being used, then this must be defined as one of those values. If they are not
            being used, then this does not needed to be specified or can be empty string. It cannot have a
            value if config.Insecticides does not define anything.
        cost (float): Unit cost per bednet
