...
def _outdoor_node_emanator(campaign,
    ...
    For killing and repelling effects - depending on the parameters you set,
    ...
    Args:
        ...
        spray_coverage (float): The proportion of the node affected. This value is multiplied by the current efficacy of the
            waning effects.
        ...
        cost (float): Unit cost per **OutdoorNodeEmanator**.
        new_property_value (str): New **NodeProperty** value to assign to individuals receiving this intervention. Must be
...
def add_outdoor_node_emanator_scheduled(campaign,
    ...
    Args:
        ...
        node_ids (list): List of node ids representing nodes to target with the intervention. [] or None indicates all
        ...
        node_property_restrictions (list): A list of dictionaries of **NodeProperties**, which are needed for the node
            to receive the intervention. Sets the **Node_Property_Restrictions**.
        receiving_broadcast_event (str): Optional. BroadcastNodeEvent that's sent out when OutdoorNodeEmanator is
            received.
        killing_initial_effect (float): Initial strength of the Killing effect. The effect may decay over time.
        killing_box_duration (float): Box duration of effect in days before the decay of **killing_initial_effect**.
        killing_decay_time_constant (float): The exponential decay length, in days of the **killing_initial_effect**.
        ...
        insecticide (str): The name of the insecticide defined in config.Insecticides for this intervention.
            ...
            value if config.Insecticides does not define anything.
        cost (float): Unit cost per **OutdoorNodeEmanator**.
        new_property_value (str): New **NodeProperty** value to assign to nodes receiving this intervention. Must be
            in format of "PropertyName:Value", e.g. "EmanatorNode:Yes".
        intervention_name (str): The optional name used to refer to this intervention as a means to differentiate it from
            others that use the same class.
    """
